...
def execution_start():
    ...
    aicrowd_events.register_event(
                ...
                payload={ #Arbitrary Payload
                    "event_type": "learning-to-smell:execution_started"
                    }
                )
...
def execution_progress(progress_payload):
    ...
    aicrowd_events.register_event(
                ...
                payload={ #Arbitrary Payload
                    "event_type": "learning-to-smell:execution_progress",
                    "image_ids" : image_ids
                    }
                )
...
def execution_success(payload):
    ...
    aicrowd_events.register_event(
                ...
                payload={ #Arbitrary Payload
                    "event_type": "learning-to-smell:execution_success",
...
def execution_error(error):
    ...
    aicrowd_events.register_event(
                ...
                payload={ #Arbitrary Payload
                    "event_type": "learning-to-smell:execution_error",
                    "error" : error
                    },
                blocking=True
                )
